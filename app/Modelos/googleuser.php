...
try{
		 ...
		 // $sql22="INSERT INTO Clientes (Client_Id,Nombre,Comprado,Fecha_creacion,Comentarios,NIF,fecha_modif,id_Contacto) VALUES (NULL, '$nombre', '0', CURRENT_TIMESTAMP, '', '', Null, NULL)";
